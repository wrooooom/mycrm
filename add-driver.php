...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $sql = "INSERT INTO drivers (full_name, phone, email, license_number, license_expiry, status) 
                VALUES (?, ?, ?, ?, ?, ?)";
...
// Если не POST запрос - показываем форму
?>
<!DOCTYPE html>
<html lang="ru">
<head>
    ...
    <title>Добавить водителя - CRM ProfTransfer</title>
    <style>
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h2 style="margin-bottom: 25px; color: #2c3e50;">👨‍💼 Добавить нового водителя</h2>
